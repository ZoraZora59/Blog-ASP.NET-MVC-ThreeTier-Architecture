    ...
    var calendar = function (calendarId) {
        ...
        c.init = function () {
            ...
            if (loadStyles.mark != 'load') {
                loadStyles(".calendarDiv {width:300px;text-align:center;}\
            .Table{width:300px;height:200px;}\
            .box{margin-left:0px;margin-right:0px;text-align:center;width:300px;height:22px;font-weight:bold;font-size:21px;}\
            ...
            .blueTr{color:#169fe6;text-align:center;};");
            }
